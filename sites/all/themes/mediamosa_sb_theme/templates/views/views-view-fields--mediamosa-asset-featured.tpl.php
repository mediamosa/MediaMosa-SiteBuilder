...
<?php if (isset($fields['still_url']) && !empty($fields['still_url']->content)): ?>
  ...
  <?php else: ?>
<?php print l(theme('image', array('path' => drupal_get_path('theme', 'mediamosa_sb_theme') . '/images/notgranted.png', 'width' => '300px', 'height' => '170px', 'alt' => t("You don't have the right permissions to access this video"))), 'asset/detail/' . $fields['asset_id']->raw, array('html' => TRUE, 'attributes' => array('class' => 'views-field-still-url'))); ?>
  <?php endif; ?>
<?php endif; ?>
